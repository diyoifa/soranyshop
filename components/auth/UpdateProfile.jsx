    ...
    <>
      ...
      >
        <form onSubmit={submitHandler}>
          <h2 className="mb-5 text-2xl font-semibold">Editar Perfil de usuario</h2>
          ...
          >
            {loading ?
             <span className="flex flex-row gap-2">
                <p>Actualizando...</p>
                <i className="inline-block w-10 h-10 border-3 border-solid border-gray-700 rounded-full border-transparent animate-spin">🔃</i>
             </span> 
             : "Modificar"}
          </button>
        </form>
