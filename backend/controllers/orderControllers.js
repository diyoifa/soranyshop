...
export const updateOrder = async (req, res) => {
  ...
  order = await Order.findByIdAndUpdate(req.query.id, {
    ...
    shippingGuide: req.body.shippingGuide,
    shippingAgency: req.body.shippingAgency
  });
  console.log("🚀 ~ file: orderControllers.js:70 ~ updateOrder ~ order:", order)
...
export const createOrder = async(req, res)=>{
  ...
  try {
    ...
    console.log("🚀 ~ file: orderControllers.js:118 ~ createOrder ~ createdOrder:", createdOrder)
...
export const checkoutSession = async (req, res) => {
  // console.log("🚀 ~ file: orderControllers.js:105 ~ checkoutSession ~ req Id:", req._id)
  const body = req.body;
  // console.log("🚀 ~ file: orderControllers.js:106 ~ checkoutSession ~ body:", body)
  ...
  const session = await stripe.checkout.sessions.create({
    ...
    shipping_options: [
      {
        shipping_rate: "shr_1NaGYsIi7j384Bc1aVCCBnVt",
      },
    ],
    line_items,
  });
...
export const webhook = async (req, res) => {
  try {
    ...
    if (event.type === "checkout.session.completed") {
      ...
      // console.log("🚀 ~ file: orderControllers.js:186 ~ webhook ~ line_items:", line_items)
